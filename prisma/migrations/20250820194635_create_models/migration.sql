...
CREATE TABLE "public"."DealershipInfo" (
    ...
    "email" TEXT DEFAULT 'contact@vehiql.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "workingHours_dealershipId_idx" ON "public"."workingHours"("dealershipId");

-- CreateIndex
CREATE INDEX "workingHours_dayOfWeek_idx" ON "public"."workingHours"("dayOfWeek");

-- CreateIndex
CREATE INDEX "workingHours_isOpen_idx" ON "public"."workingHours"("isOpen");

-- CreateIndex
CREATE UNIQUE INDEX "workingHours_dealershipId_dayOfWeek_key" ON "public"."workingHours"("dealershipId", "dayOfWeek");
...
-- AddForeignKey
ALTER TABLE "public"."workingHours" ADD CONSTRAINT "workingHours_dealershipId_fkey" FOREIGN KEY ("dealershipId") REFERENCES "public"."DealershipInfo"("id") ON DELETE CASCADE ON UPDATE CASCADE;
